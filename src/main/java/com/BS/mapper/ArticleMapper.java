...
public interface ArticleMapper {
    ...
    @Insert("insert into article(articleId,author,originalAuthor,articleTitle,publishDate,updateDate,articleContent,articleTags,articleType,articleCategories,articleTabloid,likes,lastArticleId,nextArticleId) " +
            "values(#{articleId},#{author},#{originalAuthor},#{articleTitle},#{publishDate},#{updateDate},#{articleContent},#{articleTags},#{articleType},#{articleCategories},#{articleTabloid},#{likes},#{lastArticleId},#{nextArticleId})")

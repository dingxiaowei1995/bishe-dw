...
import com.BS.constant.RoleConstant;
...
public class UserServiceImpl implements UserService {
    ...
    public String insert(User user) {
        ...
        user.setAvatarImgUrl("https://BS-myblog.oss-cn-shenzhen.aliyuncs.com/public/user/avatar/noLogin.jpg");
    ...
    public JSONObject getHeadPortraitUrl(int id) {
        ...
        if(!"".equals(avatarImgUrl) && avatarImgUrl != null){
            ...
            jsonObject.put("avatarImgUrl","https://BS-myblog.oss-cn-shenzhen.aliyuncs.com/public/user/avatar/noLogin.jpg");
        }
        return jsonObject;
    }
